...
from mdiff.iso_diff import HeckelSequenceMatcher
from mdiff.utils import OpCode


class TestHeckelSequenceComparator(unittest.TestCase):
    ...
    def test_heckel_paper_example(self):
        ...
        expected_opcodes = [OpCode(tag='delete', i1=0, i2=3, j1=0, j2=0),
                            ...
                            OpCode(tag='delete', i1=9, i2=10, j1=9, j2=9),
                            OpCode(tag='insert', i1=3, i2=3, j1=3, j2=4),
                            OpCode(tag='equal', i1=10, i2=11, j1=4, j2=5),
                            OpCode(tag='delete', i1=11, i2=13, j1=11, j2=11),
                            OpCode(tag='equal', i1=13, i2=18, j1=5, j2=10),
                            OpCode(tag='moved', i1=3, i2=3, j1=10, j2=11),
                            OpCode(tag='insert', i1=11, i2=11, j1=11, j2=12),
    ...
    def test_edge_case_1(self):
        ...
        expected_opcodes = [OpCode(tag='equal', i1=0, i2=2, j1=0, j2=2),
                            OpCode(tag='insert', i1=9, i2=9, j1=2, j2=4),
                            OpCode(tag='equal', i1=2, i2=5, j1=4, j2=7),
                            OpCode(tag='delete', i1=5, i2=10, j1=8, j2=8),
                            OpCode(tag='insert', i1=7, i2=7, j1=7, j2=12)]
        self.assertEqual(opcodes, expected_opcodes)
    ...
    def test_edge_case_2(self):
        ...
        hd = HeckelSequenceMatcher(a, b)
        opcodes = hd.get_opcodes()
        expected_opcodes = [OpCode(tag='delete', i1=0, i2=2, j1=1, j2=1),
                            OpCode(tag='equal', i1=2, i2=4, j1=0, j2=2),
                            OpCode(tag='delete', i1=4, i2=5, j1=4, j2=4),
                            OpCode(tag='insert', i1=2, i2=2, j1=2, j2=6)]
        self.assertEqual(opcodes, expected_opcodes)
    ...
    def test_edge_case_3(self):
        ...
        hd = HeckelSequenceMatcher(a, b)
        opcodes = hd.get_opcodes()
        expected_opcodes = [OpCode(tag='delete', i1=0, i2=11, j1=10, j2=10),
                            OpCode(tag='insert', i1=3, i2=3, j1=0, j2=11)]
        self.assertEqual(opcodes, expected_opcodes)
